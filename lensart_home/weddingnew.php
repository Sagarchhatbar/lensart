...
<html lang="en">
  ...
  <!-- End Portfolio section -->
	<!-- End Portfolio section --> <a href="http://localhost/lensart_home/inner-wedding.php">
	<table> <tr> <td>
	<div class="album">
	...
	{
	?>
	<img width='180px' height='200' src="../../edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php
	...
	{
	?>
	<img width='90px' height='100' src="../../edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php
	...
	{
	?>
	<img rowspan=2 colspan=2 width='90px' height='100' src="../../edmin/code/upload/<?php echo $row['wedding']; ?> "/>
	<?php
