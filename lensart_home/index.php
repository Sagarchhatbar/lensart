  ...
  <header id="header">
    <div class="header-inner">
	  ...
	  <div class="header-la-area">
        ...
        <abbr title=" click for admin login">  <a class="header-la-area" href="http://localhost/lensart_login/adminlogin.php"><img src="assets/images/LA.png" alt="logo"></a> </abbr>
		   </div>
		   </td>           
		   <td>
	  ...
	  <div class="header-btn-area" style="margin-top: 30px;">
         <!-- <a class="knowmore-btn" href="#">Home</a> -->
		      <a class="download-btn" style="margin-left: 226px; " href="../../lensart_login/LensArt_loginnew.php"  style="margin-left: 830px; margin-top:5px;">Login/Sign up</a>
        </div></td></tr>
		</table>
           </div>      
    </div> 
